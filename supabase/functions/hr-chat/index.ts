...
const employeeDirectory = [
  { name: "Amanda Foster", role: "CTO", department: "Executive", location: "Berlin", tenure: "7y 0m", manager: "Jordan Lee", email: "amanda.foster@acme.com" },
  { name: "Jordan Lee", role: "VP Engineering", department: "Engineering", location: "San Francisco", tenure: "4y 6m", manager: "Amanda Foster", email: "jordan.lee@acme.com" },
  { name: "Sam Patel", role: "Senior Engineer", department: "Engineering", location: "New York", tenure: "2y 3m", manager: "Jordan Lee", email: "sam.patel@acme.com" },
  { name: "Alex Kim", role: "Product Manager", department: "Product", location: "London", tenure: "1y 8m", manager: "Riley Park", email: "alex.kim@acme.com" },
  { name: "Morgan Chen", role: "Designer", department: "Design", location: "Austin", tenure: "3y 1m", manager: "Casey Liu", email: "morgan.chen@acme.com" },
  { name: "Riley Park", role: "VP Product", department: "Product", location: "San Francisco", tenure: "5y 2m", manager: "Amanda Foster", email: "riley.park@acme.com" },
  { name: "Casey Liu", role: "Design Lead", department: "Design", location: "Seattle", tenure: "3y 9m", manager: "Amanda Foster", email: "casey.liu@acme.com" },
  { name: "Taylor Singh", role: "Software Engineer", department: "Engineering", location: "Toronto", tenure: "1y 0m", manager: "Jordan Lee", email: "taylor.singh@acme.com" },
];
